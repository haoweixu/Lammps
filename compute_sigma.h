...
ComputeStyle(Sigma, ComputeSigma)

#else // register the fix here

#ifndef LMP_COMPUTE_SIGMA_H
#define LMP_COMPUTE_SIGMA_H
...
class ComputeSigma : public Compute {
 public:
  ComputeSigma(class LAMMPS *, int, char **);
  ~ComputeSigma();
