...
int MinSD::iterate(int maxiter)
{
  ...
  for (int iter = 0; iter < maxiter; iter++) {
    ...
    eprevious = ecurrent;
    fail = (this->*linemin)(ecurrent,alpha_final); // move particles here, linemin is a function pointer, which points to different linemin functions for different linemin style, see min_linesearch.cpp, L81. ---Haowei Xu---
    if (fail) return fail;
