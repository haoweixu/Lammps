...
void PairEAM::compute(int eflag, int vflag)
{
  ...
  // if newton_pair flag is true, each atom only owns a half list, and thus the 
  // density must be summed. See Line207, where the contribution to atom j is explicitly
  // added
